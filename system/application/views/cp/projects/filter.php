<p class="actions" class="printhide">
	<?php if (user_can('create', 'projects')) : ?>
		<a href="<?php echo site_url('projects/create'); ?>">Create new</a>
	<?php endif; ?>
		...
		<div class="span-5">
			<p>
				...
				<select name="status">
					...
					<option <?php if ($this->input->get('status') == 'Closed') echo ' selected="selected"'; ?> value="Closed">Closed</option>
					<option <?php if ($this->input->get('status') == 'In Progress') echo ' selected="selected"'; ?> value="In Progress">In Progress</option>
