	...
	<div class="span-24 last">
		...
		<?php if (user_can('create', 'documents')) : ?>
			<p><a id="new" href="#">Create new</a>
                            <a id="manage_templates" href="/cp/documents/templates">Manage templates</a>
						...
						<tr>
							...
							<td class="actions span-3">
								...
								<?php if (user_can('edit', 'documents')) : ?>
									<a class="icon edit document" href="<?php echo site_url('documents/edit_document/' . $doc->id); ?>">Edit</a>
								<?php endif; ?>
